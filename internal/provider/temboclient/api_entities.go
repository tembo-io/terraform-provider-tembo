...
/*
GetAllEntities Get the raw Stack definitions for all entities
...
*/
func (a *EntitiesApiService) GetAllEntities(ctx context.Context) ApiGetAllEntitiesRequest {
	return ApiGetAllEntitiesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []interface{}
func (a *EntitiesApiService) GetAllEntitiesExecute(r ApiGetAllEntitiesRequest) ([]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitiesApiService.GetAllEntities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/entities/all"
...
/*
GetEntity Get the json-schema for an entity
...
*/
func (a *EntitiesApiService) GetEntity(ctx context.Context, entityType string) ApiGetEntityRequest {
	return ApiGetEntityRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return interface{}
func (a *EntitiesApiService) GetEntityExecute(r ApiGetEntityRequest) (interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/entities/{entity_type}"
